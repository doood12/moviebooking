            ...
            <div class="main-content">
                <div>
                    <form method="post" action="connect.php">
                        <label for="rId">1. Enter the Reservation ID</label><br><br>
                        <input type="number" name="rId" value="<?php echo $RID ?>" readonly><br><br>
        
                        <label>2. Ratings for the ingredients</label><br>
                        ...
                        <br>
                        <br>
                        <label>3. Ratings for the taste</label><br>
                        <span class="star-rating">
                        ...
                        <br>
                        <br>
                        <label>4. Ratings for the convenience</label><br>
                        ...
                        <br>
                        <br>
                        <label for="comment">5. Any other comments</label><br><br>
