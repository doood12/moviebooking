        ...
        <div class="formDiv">
          ...
          if(isset($_SESSION['LoginStat']) == true){
              ...
              if($result->num_rows>0){
                ...
                echo "<center><form action='updateUserProfilephp.php' method='POST' style='margin-bottom: 22px;'>
                <label>Name</label>
                <input type='text' name='name' class='inputText' value='".$row['name']."'  ><br>
                <label>User Name</label>
                <input type='text' name='username' class='inputText' value='".$row['username']."' ><br>
                <label>Email</label>
                <input type='email' name='email' class='inputText' value='".$row['email']."' ><br>
                <label>Phone Number</label>
                <input type='text' name='phoneNo' class='inputText' pattern='[0-9]{10}' placeholder='0768767567' value='".$row['phoneNo']."'><br>
                <br>
                <input type='submit' class='updatebtn'>
              </form><a href='deleteUserProfile.php' class='dltbtn'>Delete</a></center>";
            }
          }
...
<!--footer------------>	
 ...
 <footer style="    float: left;">
   <div class="content">
   <img src="/Movie-Ticket-Booking-System/Home_page/logo.jfif" alt="logo"  height="60" width="60">
   
     <div class="left">
        <a href="../About_us/home.html">Contact Us</a>
     ...
     <div class="right">
	    ...
	    <a href="#"><img src="assets/star.png" alt="star" height="20" width="100"></a>
     </div>
